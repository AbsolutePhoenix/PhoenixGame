...
import games.absolutephoenix.phoenixgame.network.MinicraftClient;
...
import games.absolutephoenix.phoenixgame.screen.Display;
import games.absolutephoenix.phoenixgame.screen.MultiplayerDisplay;
import games.absolutephoenix.phoenixgame.screen.TitleDisplay;
...
public class Game {
	...
	public static final Version VERSION = new Version(Reference.VERSION);
