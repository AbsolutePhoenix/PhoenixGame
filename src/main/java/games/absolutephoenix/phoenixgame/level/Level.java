package games.absolutephoenix.phoenixgame.level;
...
public class Level {
	...
	private Set<Entity> entities = Collections.synchronizedSet(new HashSet<>()); // A list of all the entities in the world
	private Set<Player> players = Collections.synchronizedSet(new HashSet<>()); // A list of all the players in the world
